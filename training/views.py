...
from training.permissions import ManagerPermissionCreateDestroy, ManagerOrOwnerPermissionsAll, IsOwnerOnly
from training.serializators import CourseSerializer, LessonSerializer
