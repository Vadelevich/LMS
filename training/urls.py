...
from training.views import LessonListAPIView, LessonCreateAPIView, LessonUpdateAPIView, \
    ...
    CourseDestroyAPIView, CourseRetrieveAPIView, SubscriptionCreateAPIView, SubscriptionDeleteAPIView
...
urlpatterns = [
    ...
    path('create_subscr/', SubscriptionCreateAPIView.as_view(), name='create_subscr'),
    path('delete_subscr/<int:pk>/', SubscriptionDeleteAPIView.as_view(), name='detele_subscr'),
